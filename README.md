...
Este repositório foi criado para organizar todas as entregas da **Avaliação A1**, demonstrando:

* 🗂 **Organização digital profissional**
* 💼 **Posicionamento de carreira em tecnologia**
* 🧩 **Domínio das disciplinas cursadas no semestre**
* 🚀 **Evolução técnica e acadêmica**

Aqui você encontrará documentos, certificados, currículos, relatórios e o portfólio técnico desenvolvido ao longo do semestre.
